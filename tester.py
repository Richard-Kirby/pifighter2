...
class Application(tk.Frame):
    ...
    def start_workout(self):
        print("Start workout")
        self.session.pix_display.workout_attack('KickLeft')
        print('KickLeft')
        time.sleep(2)
        self.session.pix_display.workout_attack('PunchLeft')
        print('PunchLeft')
        time.sleep(2)
        self.session.pix_display.workout_attack('PunchRight')
        print('PunchRight')
        time.sleep(2)
        self.session.pix_display.workout_attack('KickRight')
        print('KickRight')
        time.sleep(2)
